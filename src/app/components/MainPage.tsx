...
function MainPage() {
    const [selectedImage, setSelectedImage] = useState(mainPageData[0]);
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between mx-5 lg:mx-60 2xl:mx-96 gap-10 mt-32 lg:mt-0">
                ...
                <div className="w-full lg:w-1/2 flex-2 flex-col gap-5 h-full">
                    <div className="lg:h-[50vh] w-full h-auto mb-9">
                        {selectedImage && (
                            <div className="flex flex-col gap-2">
                                <span className="text-secondary italic font-medium">On view in {selectedImage.room} until March 31, 2025</span>
                    ...
                    <div className="flex gap-5 2xl:mt-10">
                        <button className="bg-secondary text-black font-semibold px-4 rounded-md hover:opacity-80 cursor-pointer">visit now</button>
                        <button className="text-white font-semibold px-4 py-2 rounded-md border-2 border-white flex gap-2 items-center hover:opacity-80 cursor-pointer">
                            discover more
                            <FaArrowRightLong />
                        </button>
                    </div>
                    <div className="mt-5 2xl:mt-10 flex gap-2 lg:flex-row max-md:grid max-md:grid-cols-3 max-md:mb-20">
                        {mainPageData.map((image, index) => (
                            <div key={index}
                                 className="w-[100px] sm:w-[150px] h-[75px] sm:h-[100px] shadow-2xl cursor-pointer border-2 border-white"
